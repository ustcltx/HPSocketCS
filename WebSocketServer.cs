...
namespace HPSocketCS
{
    ...
    {
        private HttpSdk.OnWSMessageBody _OnWSMessageBody;

        private HttpSdk.OnWSMessageComplete _OnWSMessageComplete;

        private HttpSdk.OnWSMessageHeader _OnWSMessageHeader;
