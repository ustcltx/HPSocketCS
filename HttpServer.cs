...
namespace HPSocketCS
{
    ...
    {
        private HttpSdk.OnBody _OnBody;

        private HttpSdk.OnChunkComplete _OnChunkComplete;

        private HttpSdk.OnChunkHeader _OnChunkHeader;

        private HttpSdk.OnHeader _OnHeader;

        private HttpSdk.OnHeadersComplete _OnHeadersComplete;

        private HttpSdk.OnMessageBegin _OnMessageBegin;

        private HttpSdk.OnMessageComplete _OnMessageComplete;

        private HttpSdk.OnParseError _OnParseError;

        private HttpSdk.OnRequestLine _OnRequestLine;

        private HttpSdk.OnUpgrade _OnUpgrade;
        ...
        /// <summary>
        /// 名称：释放连接 描述：把连接放入释放队列，等待某个时间（通过 SetReleaseDelay() 设置）关闭连接
        /// </summary>
        ...
        /// <summary>
        /// 名称：发送本地文件 描述：向指定连接发送 4096 KB 以下的小文件
        /// </summary>
        /// <param name="connId"></param>
